...
const API_BASE_URL = import.meta.env.VITE_API_URL || "https://6c905a3b-3aaf-44b8-9641-4c2e8a899abb-dev.e1-us-east-azure.choreoapis.dev/crave-meal-planner/backend/v1.0";
